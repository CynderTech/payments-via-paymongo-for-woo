...
<div class="my-1">
    ...
    <div class="form-row form-row-wide">
        ...
        <input id="paymongo_ccNo" class="paymongo_ccNo" type="text" autocomplete="off">
    </div>
    <div class="form-row form-row-first">
        <label>Expiry Date <span class="required">*</span></label>
        <input id="paymongo_expdate" class="paymongo_expdate" type="text" autocomplete="off" placeholder="MM / YY">
    </div>
    <div class="form-row form-row-last">
        <label>Card Code (CVC) <span class="required">*</span></label>
        <input id="paymongo_cvv" class="paymongo_cvv" type="password" autocomplete="off" placeholder="CVC">
    </div>
    <div id="installment-container" class="woocommerce-PaymentBox woocommerce-PaymentBox--paymongo payment_box payment_method_paymongo_card_installment">
        <div class="my-1">
